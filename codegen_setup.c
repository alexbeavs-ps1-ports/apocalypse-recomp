...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "APOCALYPSE_PROJECT_ROOT",
    .build_dir_env = "APOCALYPSE_BUILD_DIR",
    .force_setup_env = "APOCALYPSE_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_004.60_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Apocalypse_Recompiled",
    .prepare_note =
