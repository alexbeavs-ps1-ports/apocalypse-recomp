# Apocalypse release candidate

The accepted Wave3 candidate and title-specific corrections remain the source control. This release adds canonical Redump input identities and a portable setup route. Exact-package setup and gameplay checks remain separate from prior title acceptance.
